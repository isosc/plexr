...
def write_image_ll (io, engine, image, var_name, end_step=False):
    pass

def write_png_image_ll (io, engine, image, var_name, end_step=False):
    pass

def write_image_from_matplotlib_ll (io, engine, fig, var_name, end_step=False):
    pass

def write_png_image_from_matplotlib_ll (io, engine, fig, var_name, end_step=False):
    pass
